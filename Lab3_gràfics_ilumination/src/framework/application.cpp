...
void Application::render(Image& framebuffer) {
    ...
    for (int i = 0; i < mesh->vertices.size(); i=i+3) {
        ...
        Vector3 normal1 = mesh->normals[i]; //extract normal from mesh
        ...
        else if(render_task == lab4){
            framebuffer.drawTriangleInterpolatedIllumination(framebuffer, normalized_point1, normalized_point2, normalized_point3, normal1, normal2, normal3, vertex1, vertex2, vertex3, ambient_light, zbuffer, light, material, camera);
        }
    }
}
...
void Application::update(double seconds_elapsed) {
    ...
    /* FOR TASK OF LAB 4 - SINGLE LIGHT */
