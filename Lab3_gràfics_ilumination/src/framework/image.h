...
public:
    ...
    void drawTriangleInterpolatedIllumination(Image& colorbuffer, const Vector3& p0, const Vector3& p1, const Vector3& p2, const Vector3& n0, const Vector3& n1, const Vector3& n2,const Vector3& uv0, const Vector3& uv1, const Vector3& uv2, Vector3& ambient_light, FloatImage& zbuffer, Light* light, Material* material, Camera* camera);
};
